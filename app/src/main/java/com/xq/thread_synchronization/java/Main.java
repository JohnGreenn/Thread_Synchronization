...
//                count++;
    ...
    static void runSynchronized1Demo() {
        new com.xq.thread_synchronization.java.Synchronized1Demo().runTest();
    }

    static void runSynchronized2Demo() {
        new com.xq.thread_synchronization.java.Synchronized2Demo().runTest();
    }

    static void runSynchronized3Demo() {
        new com.xq.thread_synchronization.java.Synchronized3Demo().runTest();
    }

    static void runReadWriteLockDemo() {
        new com.xq.thread_synchronization.java.ReadWriteLockDemo().runTest();
    }
}
